...
export default function Home() {
  return (
    <main className="flex flex-col justify-center items-center h-screen">
      <ResponsiveImage src="/img/logo.svg" alt="Logo" width={120} height={120} />

      <AnimatedGradientText>Song Quest</AnimatedGradientText>
      <ButtonRow>
        <IconButton>
          <Link href="https://github.com/spongycode/song-quest/releases/download/1.0.0/song-quest-1.0.0.apk" target="_blank">
            <Button>Get the app <AndroidIcon /> </Button>
          </Link>
        </IconButton>
        <IconButton>
          <Link href="https://github.com/spongycode/song-quest" target="_blank">
...
const AnimatedGradientText = styled.div`
  ...
  background: -webkit-linear-gradient(-45deg, #f72828, #e7e1dd);
  background-size: 300%;
  font-size: 2.5em;
  font-weight: 500;
